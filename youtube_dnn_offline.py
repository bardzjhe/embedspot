...
def main(dataset_path, model_name, epoch, learning_rate, batch_size, weight_decay, device, save_dir, seed):
    ...
    match_evaluation(user_embedding, item_embedding, test_user, all_item, topk=300)


if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_path', default="examples/matching/data/ml-1m/ml-1m.csv")
