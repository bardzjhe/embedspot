...
data_path = r"F:/Sem2 Y4/Final_FYP_code/embed-spot/examples/matching/data/"
...
data.to_csv(r"F:/Sem2 Y4/Final_FYP_code/embed-spot/examples/matching/data/ml-1m/ml-1m.csv", index=False)